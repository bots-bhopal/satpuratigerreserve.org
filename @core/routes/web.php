...
Route::group(['middleware' => ['setlang:frontend', 'globalVariable', 'maintains_mode']], function () {
    ...
    Route::get('/notice-download/{filename}', 'FrontendController@downloadNotice')->name('user.notice.download');
...
Route::group(['middleware' => ['setlang:frontend', 'globalVariable', 'maintains_mode', 'HtmlMinifier']], function () {
    ...
    $strevent_page_slug = get_static_option('strevent_page_slug') ?? 'strevent';
    ...
    $ntender_page_slug = get_static_option('ntender_page_slug') ?? 'ntender';
    $announcement_page_slug = get_static_option('announcement_page_slug') ?? 'announcement';
    $dlink_page_slug = get_static_option('dlink_page_slug') ?? 'dlinks';
    ...
    Route::get($news_page_slug . '/{slug}', 'FrontendController@news_single_page')->name('frontend.news.single');
     ...
     /*--------------------------------------
        FRONTEND: STR EVENTS ROUTES
    ---------------------------------------*/
    Route::get($strevent_page_slug, 'FrontendController@strevent_page')->name('frontend.strevent');
    Route::get($strevent_page_slug . '/{slug}', 'FrontendController@strevent_single_page')->name('frontend.strevent.single');
    ...
    ---------------------------------------*/
    Route::get($ntender_page_slug, 'FrontendController@ntender_page')->name('frontend.ntender');
    // Route::get($notice_page_slug . '/{slug}', 'FrontendController@notice_single_page')->name('frontend.notice.single');

    /*--------------------------------------
        FRONTEND: IMP LINKS ROUTES
    ---------------------------------------*/
    Route::get($dlink_page_slug, 'FrontendController@dlink_page')->name('frontend.dlink');

    /*--------------------------------------
        FRONTEND: ANNOUNCEMENT BOARD ROUTES
    ---------------------------------------*/
    Route::get($announcement_page_slug, 'FrontendController@announcement_page')->name('frontend.aboard');
...
Route::prefix('admin-home')->middleware(['setlang:backend'])->group(function () {
    ...
    Route::middleware(['adminPermissionCheck:Home Page Manage'])->group(function () {
       ...
       -----------------------------------------*/
        ...
        Route::group(['prefix' => 'home-09'], function () {
            ...
            Route::get('/video-area', 'ConstructionHomePageController@video_area')->name('admin.home09.video.area');
            Route::post('/video-area', 'ConstructionHomePageController@update_video_area');
            ...
            Route::get('/gallery-area', 'ConstructionHomePageController@gallery_area')->name('admin.home09.gallery.area');
            Route::post('/gallery-area', 'ConstructionHomePageController@update_gallery_area');
            ...
            Route::get('/announcement-area', 'ConstructionHomePageController@announcement_area')->name('admin.home09.announcement.area');
            Route::post('/announcement-area', 'ConstructionHomePageController@update_announcement_area');
            Route::get('/notice-area', 'ConstructionHomePageController@notice_area')->name('admin.home09.notice.area');
            Route::post('/notice-area', 'ConstructionHomePageController@update_notice_area');
        });
 ...
 ==============================================*/
    ...
    /*==============================================
       STR EVENTS
    ==============================================*/
    Route::prefix('strevent')->middleware(['adminPermissionCheck:Event Manage'])->group(function () {
        /*-------------------------
          STR EVENTS ROUTES
        --------------------------*/
        Route::get('/', 'StrEventController@index')->name('admin.strevent');
        Route::get('/new', 'StrEventController@new_event')->name('admin.strevent.new');
        Route::post('/new', 'StrEventController@store_new_event');
        Route::post('/clone', 'StrEventController@clone_event')->name('admin.strevent.clone');
        Route::get('/edit/{id}', 'StrEventController@edit_event')->name('admin.strevent.edit');
        Route::post('/update/{id}', 'StrEventController@update_event')->name('admin.strevent.update');
        Route::post('/delete/{id}', 'StrEventController@delete_event')->name('admin.strevent.delete');
        Route::post('/bulk-action', 'StrEventController@bulk_action')->name('admin.strevent.bulk.action');
        Route::post('/slug-check', 'StrEventController@slug_check')->name('admin.strevent.slug.check');

        /*-------------------------
           STR EVENTS PAGE SETTINGS ROUTES
        --------------------------*/
        Route::get('/page-settings', 'StrEventController@event_page_settings')->name('admin.strevent.page.settings');
        Route::post('/page-settings', 'StrEventController@update_event_page_settings');
    });
    ...
    /*==============================================
       DOCUMENT
    ==============================================*/
    // Route::prefix('document')->middleware(['adminPermissionCheck:Document Manage'])->group(function () {
    //     /*-------------------------
    ...
    //     /*-------------------------
    //         NOTICE OR ORDER PAGE SETTINGS ROUTES
    //     --------------------------*/
    //     Route::get('/page-settings', 'NoticeOrderController@notice_page_settings')->name('admin.notice.page.settings');
    //     Route::post('/page-settings', 'NoticeOrderController@update_notice_page_settings');

    //     /*-------------------------
    //       NOTICE OR ORDER ROUTES
    //     --------------------------*/
    //     // Route::get('/check-slug', 'NoticeOrderController@checkSlug')->name('slug.check');
    //     Route::post('/bulk-action', 'NoticeOrderController@bulk_action')->name('admin.notice.bulk.action');
    //     Route::get('/', 'NoticeOrderController@index')->name('admin.notice');
    //     Route::get('/new', 'NoticeOrderController@create')->name('admin.notice.new');
    //     Route::post('/new', 'NoticeOrderController@store')->name('admin.notice.store');
    //     Route::get('/{id}/edit', 'NoticeOrderController@edit')->name('admin.notice.edit');
    //     Route::match(['get', 'post'], '/{id}/update', 'NoticeOrderController@update')->name('admin.notice.update');
    //     Route::match(['get', 'post'], '/{id}', 'NoticeOrderController@destroy')->name('admin.notice.destroy');
    // });

    /*==============================================
       ANNOUNCEMENT BOARD
    ==============================================*/
    Route::prefix('aboard')->middleware(['adminPermissionCheck:Aboard Manage'])->group(function () {
        /*-------------------------
        ANNOUNCEMENT BOARD PAGE SETTINGS ROUTES
        --------------------------*/
        Route::get('/page-settings', 'AboardController@aboard_page_settings')->name('admin.aboard.page.settings');
        Route::post('/page-settings', 'AboardController@update_aboard_page_settings');

        /*-------------------------
        ANNOUNCEMENT BOARD CATEGORY ROUTES
        --------------------------- */
        Route::get('/category', 'AbCategoryController@index')->name('admin.abcategories');
        Route::get('/new-category', 'AbCategoryController@create')->name('admin.abcategory.new');
        Route::post('/new-category', 'AbCategoryController@store')->name('admin.abcategory.store');
        Route::get('/{id}/edit/category', 'AbCategoryController@edit')->name('admin.abcategory.edit');
        Route::match(['get', 'post'], '/{id}/update/category', 'AbCategoryController@update')->name('admin.abcategory.update');
        Route::match(['get', 'delete'], '/{id}/category', 'AbCategoryController@destroy')->name('admin.abcategory.destroy');

        /*-------------------------
        ANNOUNCEMENT BOARD ROUTES
        --------------------------*/
        Route::get('/', 'AboardController@index')->name('admin.aboard');
        Route::get('/new', 'AboardController@create')->name('admin.aboard.new');
        Route::post('/new', 'AboardController@store')->name('admin.aboard.store');
        Route::get('/{id}/edit', 'AboardController@edit')->name('admin.aboard.edit');
        Route::match(['get', 'post'], '/{id}/update', 'AboardController@update')->name('admin.aboard.update');
        Route::match(['get', 'delete'], '/{id}', 'AboardController@destroy')->name('admin.aboard.destroy');
    });

    /*==============================================
    DLINKS
    ==============================================*/
    Route::prefix('dlink')->middleware(['adminPermissionCheck:Dlink Manage'])->group(function () {
        /*-------------------------
        DLINK PAGE SETTINGS ROUTES
        --------------------------*/
        Route::get('/page-settings', 'DlinkController@dlink_page_settings')->name('admin.dlink.page.settings');
        Route::post('/page-settings', 'DlinkController@update_dlink_page_settings');

        /*-------------------------
        DLINK CATEGORY ROUTES
        --------------------------- */
        Route::get('/category', 'DlCategoryController@index')->name('admin.dlcategories');
        Route::get('/new-category', 'DlCategoryController@create')->name('admin.dlcategory.new');
        Route::post('/new-category', 'DlCategoryController@store')->name('admin.dlcategory.store');
        Route::get('/{id}/edit/category', 'DlCategoryController@edit')->name('admin.dlcategory.edit');
        Route::match(['get', 'post'], '/{id}/update/category', 'DlCategoryController@update')->name('admin.dlcategory.update');
        Route::match(['get', 'delete'], '/{id}/category', 'DlCategoryController@destroy')->name('admin.dlcategory.destroy');

        /*-------------------------
        DLINK ROUTES
        --------------------------*/
        Route::get('/', 'DlinkController@index')->name('admin.dlinks');
        Route::get('/new', 'DlinkController@create')->name('admin.dlink.new');
        Route::post('/new', 'DlinkController@store')->name('admin.dlink.store');
        Route::get('/{id}/edit', 'DlinkController@edit')->name('admin.dlink.edit');
        Route::match(['get', 'post'], '/{id}/update', 'DlinkController@update')->name('admin.dlink.update');
        Route::match(['get', 'delete'], '/{id}', 'DlinkController@destroy')->name('admin.dlink.destroy');
    });

    /*==============================================
    NOTICE & TENDER
    ==============================================*/
    Route::prefix('ntender')->middleware(['adminPermissionCheck:Ntender Manage'])->group(function () {
        /*-------------------------
        DLINK PAGE SETTINGS ROUTES
        --------------------------*/
        Route::get('/page-settings', 'NtenderController@ntender_page_settings')->name('admin.ntender.page.settings');
        Route::post('/page-settings', 'NtenderController@update_ntender_page_settings');

        /*-------------------------
        DLINK CATEGORY ROUTES
        --------------------------- */
        Route::get('/category', 'NtCategoryController@index')->name('admin.ntcategories');
        Route::get('/new-category', 'NtCategoryController@create')->name('admin.ntcategory.new');
        Route::post('/new-category', 'NtCategoryController@store')->name('admin.ntcategory.store');
        Route::get('/{id}/edit/category', 'NtCategoryController@edit')->name('admin.ntcategory.edit');
        Route::match(['get', 'post'], '/{id}/update/category', 'NtCategoryController@update')->name('admin.ntcategory.update');
        Route::match(['get', 'delete'], '/{id}/category', 'NtCategoryController@destroy')->name('admin.ntcategory.destroy');

        /*-------------------------
        DLINK ROUTES
        --------------------------*/
        Route::get('/', 'NtenderController@index')->name('admin.ntenders');
        Route::get('/new', 'NtenderController@create')->name('admin.ntender.new');
        Route::post('/new', 'NtenderController@store')->name('admin.ntender.store');
        Route::get('/{id}/edit', 'NtenderController@edit')->name('admin.ntender.edit');
        Route::match(['get', 'post'], '/{id}/update', 'NtenderController@update')->name('admin.ntender.update');
        Route::match(['get', 'delete'], '/{id}', 'NtenderController@destroy')->name('admin.ntender.destroy');
    });

    /*==============================================
       VISITOR COUNTER
    ==============================================*/
    Route::prefix('visitor')->middleware(['adminPermissionCheck:Visitor Manage'])->group(function () {
        /*-------------------------
          VISITOR ROUTES
        --------------------------*/
        Route::get('/', 'VisitorController@index')->name('admin.visitor');
        // Route::get('/new', 'VisitorController@create')->name('admin.visitor.new');
        // Route::post('/new', 'VisitorController@store')->name('admin.visitor.store');
        Route::get('/{id}/edit', 'VisitorController@edit')->name('admin.visitor.edit');
        Route::match(['get', 'post'], '/{id}/update', 'VisitorController@update')->name('admin.visitor.update');
        // Route::match(['get', 'delete'], '/{id}', 'VisitorController@destroy')->name('admin.visitor.destroy');
    });

    Route::prefix('visitor-image')->middleware(['adminPermissionCheck:Photo Manage'])->group(function () {
        Route::get('/', 'MonthPhotoController@index')->name('admin.photo.all');
        Route::post('/new', 'MonthPhotoController@store')->name('admin.photo.new');
        Route::post('/update', 'MonthPhotoController@update')->name('admin.photo.update');
        Route::post('/delete/{id}', 'MonthPhotoController@delete')->name('admin.photo.delete');
        Route::post('/bulk-action', 'MonthPhotoController@bulk_action')->name('admin.photo.bulk.action');
    });
