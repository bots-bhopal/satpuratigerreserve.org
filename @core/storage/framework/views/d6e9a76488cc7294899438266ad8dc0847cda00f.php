...
<?php endif; ?> 
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <!-- form start -->
                        <form action="<?php echo e(route('admin.ntender.store')); ?>" method="POST" enctype="multipart/form-data"
                            class="form-horizontal">
                            <?php echo csrf_field(); ?>
                            <!-- Horizontal Form -->
                            <div class="card card-info mb-5">
                                <div class="card-header bg-dark text-white">
                                    <h3 class="card-title mb-0">Notices & Tenders</h3>
                                </div>
                                <!-- /.card-header -->
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u376743586/domains/satpuratigerreserve.org/public_html/@core/resources/views/backend/pages/ntender/create.blade.php ENDPATH**/ ?>