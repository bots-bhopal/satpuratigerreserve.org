...
<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Announcement Board')); ?>
...
<?php endif; ?> 
                    ...
                    <div class="col-lg-12">
                        <div class="card mb-5">
                            <div class="card-body">
                                <h4 class="header-title"><?php echo e(__('Announcement Board')); ?></h4>
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo e($announcement->original_filename ?? ''); ?></td>
                                                        <td><?php echo e($announcement->url ?? ''); ?></td>
                                                        <td class="text-center">
                                                            <a href="<?php echo e(route('admin.aboard.edit', $announcement->id)); ?>"
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-danger mt-1"
                                                                onclick="deleteTender(<?php echo e($announcement->id); ?>)"
                                                                data-toggle="tooltip" data-placement="top" title="Delete"
                                                                style="font-size: 14px; font-weight: 500;"><i
                                                                    class="fa fa-trash-alt"></i> Delete</button>
                                                            <form id="delete-form-<?php echo e($announcement->id); ?>"
                                                                action="<?php echo e(route('admin.aboard.destroy', $announcement->id)); ?>"
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u376743586/domains/satpuratigerreserve.org/public_html/@core/resources/views/backend/pages/aboard/index.blade.php ENDPATH**/ ?>