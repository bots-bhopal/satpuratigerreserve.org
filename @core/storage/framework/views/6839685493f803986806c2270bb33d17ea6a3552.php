...
">
    ...
    <div class="login-box" style="display: block;">
        <a href="<?php echo e(route('admin.login')); ?>" target="_blank">
            <i class="fa fa-user" aria-hidden="true" style="margin-right: 5px;"></i> <?php echo e(__('Department Login')); ?>
...
<?php /**PATH /home/u376743586/domains/satpuratigerreserve.org/public_html/@core/resources/views/frontend/partials/footer.blade.php ENDPATH**/ ?>