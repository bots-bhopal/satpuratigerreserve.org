                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <h4 class="header-title"><?php echo e(__('Add Event')); ?></h4>
                            <a href="<?php echo e(route('admin.strevent')); ?>" class="btn btn-primary"><?php echo e(__('All Events')); ?></a>
                        </div>

                        <form action="<?php echo e(route('admin.strevent.new')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-lg-8">
...
<?php endif; ?> 
                                    <button type="submit"
                                        class="btn btn-primary mt-4 pr-4 pl-4"><?php echo e(__('Add Event')); ?></button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\satpuratigerreserve.org\@core\resources\views/backend/pages/strevent/new.blade.php ENDPATH**/ ?>