...
<?php endif; ?> 
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <!-- form start -->
                        <form action="<?php echo e(route('admin.aboard.store')); ?>" method="POST" enctype="multipart/form-data"
                            class="form-horizontal">
                            <?php echo csrf_field(); ?>
                            <!-- Horizontal Form -->
                            <div class="card card-info mb-5">
                                <div class="card-header bg-dark text-white">
                                    <h3 class="card-title mb-0">Announcement Board</h3>
                                </div>
                                <!-- /.card-header -->
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\satpuratigerreserve.org\@core\resources\views/backend/pages/aboard/create.blade.php ENDPATH**/ ?>