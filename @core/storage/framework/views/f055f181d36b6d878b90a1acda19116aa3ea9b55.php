...
<?php endif; ?> 
                    ...
                    <div class="col-lg-12">
                        <div class="card mb-5">
                            <div class="card-body">
                                <h4 class="header-title"><?php echo e(__('All Category')); ?></h4>
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-left">
                                                            <a href="<?php echo e(route('admin.ntcategory.edit', $category->id)); ?>"
                                                            ...
                                                            <form id="delete-form-<?php echo e($category->id); ?>"
                                                                action="<?php echo e(route('admin.ntcategory.destroy', $category->id)); ?>"
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\satpuratigerreserve.org\@core\resources\views/backend/pages/ntender/category/index.blade.php ENDPATH**/ ?>