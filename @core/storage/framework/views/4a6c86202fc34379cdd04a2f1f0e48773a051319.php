...
<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Announcement Board Page')); ?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <!-- form start -->
                <form action="<?php echo e(route('admin.aboard.update', $data->id)); ?>" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="col-lg-8 col-md-8 offset-lg-2 offset-md-2">
                            ...
                            <div class="card card-info mt-5 mb-5">
                                <div class="card-header bg-dark text-white">
                                    <h3 class="card-title mb-0">Edit Announcement Board</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body pb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="title" class="form-control" id="title" name="title"
                                            value="<?php echo e($data->title); ?>" placeholder="<?php echo e(__('Enter Title')); ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="categories" id="category"
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php if($data->category_id == $category->id): ?> selected <?php endif; ?> value="<?php echo e($category->id); ?>"><?php echo e($category->name); ?>
                                    ...
                                    <div class="form-group website-url">
                                        ...
                                        <input type="url" class="form-control" id="customurl" name="customurl"
                                            value="<?php echo e($data->url); ?>" placeholder="<?php echo e(__('https://www.example.com')); ?>"
                                            autocomplete="off">
                                    </div>
                                </div>
                                <!-- /.card-body -->
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\satpuratigerreserve.org\@core\resources\views/backend/pages/aboard/edit.blade.php ENDPATH**/ ?>