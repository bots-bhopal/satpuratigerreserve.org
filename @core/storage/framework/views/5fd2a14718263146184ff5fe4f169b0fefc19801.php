                    ...
                    <div class="col-md-8 offset-md-2">
                        ...
                        <div class="card card-info">
                            <div class="card-header bg-dark text-white">
                                <h3 class="card-title mb-0"><?php echo e(__('Create Important Links Category')); ?></h3>
                            </div>
                            <!-- /.card-header -->
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\satpuratigerreserve.org\@core\resources\views/backend/pages/link/category.blade.php ENDPATH**/ ?>