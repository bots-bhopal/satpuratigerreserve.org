    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <!-- form start -->
                <form action="<?php echo e(route('admin.ntender.update', $ntender->id)); ?>" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="card-body pb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="title" class="form-control" id="title" name="title"
                                            value="<?php echo e($ntender->title); ?>" placeholder="<?php echo e(__('Enter Title')); ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="categories" id="category"
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php if($ntender->ntcategory_id == $category->id): ?> selected <?php endif; ?> value="<?php echo e($category->id); ?>"><?php echo e($category->name); ?>
                                    ...
                                    <?php if($ntender->url): ?>
                                        ...
                                        <div class="form-group website-url">
                                            ...
                                            <input type="url" class="form-control" id="customurl" name="customurl"
                                                value="<?php echo e($ntender->url); ?>" placeholder="<?php echo e(__('https://www.example.com')); ?>"
                                                autocomplete="off">
                                        </div>
                                    <?php endif; ?>

                                    <?php if($ntender->file_extension): ?>
                                        <?php if($ntender->file_extension == 'doc' || $ntender->file_extension == 'docx'): ?>
                                            <img src="<?php echo e(asset('assets/frontend/img/word.png')); ?>"
                                                ...
                                                alt="doc-image">
                                            <span
                                                style="font-weight: 600; position: relative; top: 4px;"><?php echo e($ntender->original_filename); ?></span>
                                        <?php endif; ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u376743586/domains/satpuratigerreserve.org/public_html/@core/resources/views/backend/pages/ntender/edit.blade.php ENDPATH**/ ?>