...
class AdminDashboardController extends Controller
{
    ...
    public function adminIndex()
    {
        ...
        $all_event = Strevent::where('lang', $default_lang)->count();
        // $all_tenders = Tender::where('lang', $default_lang)->count();
        $all_dlinks = Dlink::count();
        $all_ntender = Ntender::count();
        // $all_notices = NoticeOrder::where('lang', $default_lang)->count();
        ...
        return view('backend.admin-home')->with([
            ...
            'news_count' => $all_news,
            'event_count' => $all_event,
            // 'tender_count' => $all_tenders,
            'dlinks_count' => $all_dlinks,
            'ntender_count' => $all_ntender,
            // 'notice_count' => $all_notices,
