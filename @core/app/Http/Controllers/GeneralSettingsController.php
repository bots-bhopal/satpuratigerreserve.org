...
class GeneralSettingsController extends Controller
{
    ...
    public function update_page_settings(Request $request)
    {
        $this->validate($request, [
            ...
            'strevent_page_slug' => 'required|string|max:191',
            'announcement_page_slug' => 'required|string|max:191',
            // 'tender_page_slug' => 'required|string|max:191',
            // 'document_page_slug' => 'required|string|max:191',
            'link_page_slug' => 'required|string|max:191',
            'ntender_page_slug' => 'required|string|max:191',
            // 'notice_page_slug' => 'required|string|max:191',
        ...
        $slug_list = [
            'contact', 'blog', 'news','strevent', 'announcement' , 'link', 'ntender', 'image_gallery', 'video_gallery'
        ];
        ...
        foreach ($all_languages as $lang) {
            $this->validate($request, [
                ...
                'strevent_page_' . $lang->slug . '_name' => 'nullable|string',
                'announcement_page_' . $lang->slug . '_name' => 'nullable|string',
                ...
                'ntender_page_' . $lang->slug . '_name' => 'nullable|string',
                // 'notice_page_' . $lang->slug . '_name' => 'nullable|string',
