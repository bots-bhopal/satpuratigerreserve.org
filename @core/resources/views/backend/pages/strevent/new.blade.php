                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <h4 class="header-title">{{ __('Add Event') }}</h4>
                            <a href="{{ route('admin.strevent') }}" class="btn btn-primary">{{ __('All Events') }}</a>
                        </div>

                        <form action="{{ route('admin.strevent.new') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-8">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <x-media-upload :id="''" :name="'image'" :dimentions="'1920x1280'"
                                        :title="__('Image')" />
                                    <button type="submit"
                                        class="btn btn-primary mt-4 pr-4 pl-4">{{ __('Add Event') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
