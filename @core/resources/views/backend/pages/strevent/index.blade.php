    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{ __('All Event Items') }}</h4>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            @php $a=0; @endphp
                            @foreach ($all_events as $key => $blog)
                                <li class="nav-item">
                                            ...
                                            <tbody>
                                                @foreach ($blog as $data)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <x-delete-popover :url="route('admin.strevent.delete', $data->id)" />

                                                            <a class="btn btn-xs btn-primary btn-xs mb-3 mr-1"
                                                                href="{{ route('admin.strevent.edit', $data->id) }}">
                                                                <i class="ti-pencil"></i>
                                                            </a>
                                                            <form action="{{ route('admin.strevent.clone') }}" method="post"
