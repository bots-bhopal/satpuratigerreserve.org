    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-0">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{ __('All Notice & Tender Items') }}</h4>
                                            ...
                                            <tbody>
                                                @foreach ($documents as $data)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <x-delete-popover :url="route('admin.notice.destroy', $data->id)" />

                                                            <a class="btn btn-xs btn-primary btn-xs mb-3 mr-1"
                                                                href="{{ route('admin.notice.edit', $data->id) }}">
                                                                <i class="ti-pencil"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
        ...
        $(document).ready(function() {
            $(document).on('click', '#bulk_delete_btn', function(e) {
                ...
                if (allIds != '' && bulkOption == 'delete') {
                    ...
                    $.ajax({
                        'type': "POST",
                        'url': "{{ route('admin.notice.bulk.action') }}",
                        'data': {
                            _token: "{{ csrf_token() }}",
                            ids: allIds
                        },
