            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card mb-5">
                            <div class="card-body">
                                <h4 class="header-title">{{ __('Announcement Board') }}</h4>
                                            ...
                                            <tbody>
                                                @foreach ($announcements as $key => $announcement)
                                                    <tr>
                                                        ...
                                                        <td>{{ $announcement->original_filename ?? '' }}</td>
                                                        <td>{{ $announcement->url ?? '' }}</td>
                                                        <td class="text-center">
                                                            <a href="{{ route('admin.aboard.edit', $announcement->id) }}"
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-danger mt-1"
                                                                onclick="deleteTender({{ $announcement->id }})"
                                                                data-toggle="tooltip" data-placement="top" title="Delete"
                                                                style="font-size: 14px; font-weight: 500;"><i
                                                                    class="fa fa-trash-alt"></i> Delete</button>
                                                            <form id="delete-form-{{ $announcement->id }}"
                                                                action="{{ route('admin.aboard.destroy', $announcement->id) }}"
