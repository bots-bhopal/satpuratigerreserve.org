    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <!-- form start -->
                <form action="{{ route('admin.aboard.update', $data->id) }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="card-body pb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="categories" id="category"
                                            ...
                                            @foreach ($categories as $category)
                                                <option @if($data->category_id == $category->id) selected @endif value="{{$category->id}}">{{ $category->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group website-url">
                                        ...
                                        <input type="url" class="form-control" id="customurl" name="customurl"
                                            value="{{ $data->url }}" placeholder="{{ __('https://www.example.com') }}"
                                            autocomplete="off">
                                    </div>
                                </div>
                                <!-- /.card-body -->
