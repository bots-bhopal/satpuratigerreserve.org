        ...
        <div class="menu-inner">
            <nav id="main_menu_wrap">
                <ul class="metismenu" id="menu">
                    ...
                    @if (check_page_permission_by_string('Event Manage'))
                        <li
                            class="main_dropdown
                        @if (request()->is(['admin-home/strevent/*', 'admin-home/strevent'])) active @endif
                        ">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i>
                                <span>{{ __('Events') }}</span></a>
                            <ul class="collapse">
                                <li class="{{ active_menu('admin-home/strevent') }}"><a
                                        href="{{ route('admin.strevent') }}">{{ __('All Event') }}</a></li>
                                <li class="{{ active_menu('admin-home/strevent/new') }}"><a
                                        href="{{ route('admin.strevent.new') }}">{{ __('Add New Event') }}</a></li>
                                <li class="{{ active_menu('admin-home/strevent/page-settings') }}"><a
                                        href="{{ route('admin.strevent.page.settings') }}">{{ __('Event Page Settings') }}</a>
                                </li>
                            </ul>
                        </li>
                    @endif
                    ...
                    {{-- @if (check_page_permission_by_string('Notice Manage'))
                        <li
                            class="main_dropdown
                        @if (request()->is(['admin-home/notice/*', 'admin-home/notice'])) active @endif
                        ">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i>
                                <span>{{ __('Notices & Tenders') }}</span></a>
                            <ul class="collapse">
                                <li class="{{ active_menu('admin-home/notice') }}"><a
                                        href="{{ route('admin.notice') }}">{{ __('All Notices & Tenders') }}</a></li>
                                <li class="{{ active_menu('admin-home/notice/new') }}"><a
                                        href="{{ route('admin.notice.new') }}">{{ __('Add New Notice or Tender') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/notice/page-settings') }}"><a
                                        href="{{ route('admin.notice.page.settings') }}">{{ __('Notice or Tender Page Settings') }}</a>
                                </li>
                            </ul>
                        </li>
                    @endif --}}

                    {{-- @if (check_page_permission_by_string('Document Manage'))
                        <li
                            class="main_dropdown
                    ...
                    @if (check_page_permission_by_string('Aboard Manage'))
                        <li
                            class="main_dropdown
                        @if (request()->is(['admin-home/aboard/*', 'admin-home/aboard'])) active @endif
                        ">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i>
                                <span>{{ __('Announcement Board') }}</span></a>
                            <ul class="collapse">
                                <li class="{{ active_menu('admin-home/aboard') }}"><a
                                        href="{{ route('admin.aboard') }}">{{ __('All Announcement') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/aboard/new') }}"><a
                                    href="{{ route('admin.aboard.new') }}">{{ __('Add Announcement') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/aboard/category') }}"><a
                                    href="{{ route('admin.abcategories') }}">{{ __('All Categories') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/aboard/new-category') }}"><a
                                        href="{{ route('admin.abcategory.new') }}">{{ __('Add New Category') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/aboard/page-settings') }}"><a
                                    href="{{ route('admin.aboard.page.settings') }}">{{ __('Page Settings') }}</a>
                                </li>
                            </ul>
                        </li>
                    @endif

                    @if (check_page_permission_by_string('Dlink Manage'))
                        <li
                            class="main_dropdown
                        @if (request()->is(['admin-home/dlink/*', 'admin-home/dlink'])) active @endif
                        ">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i>
                                <span>{{ __('Documents & Links') }}</span></a>
                            <ul class="collapse">
                                <li class="{{ active_menu('admin-home/dlink') }}"><a
                                    href="{{ route('admin.dlinks') }}">{{ __('All Documents & Links') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/dlink/new') }}"><a
                                    href="{{ route('admin.dlink.new') }}">{{ __('Add Document & Link') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/dlink/category') }}"><a
                                    href="{{ route('admin.dlcategories') }}">{{ __('All Categories') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/dlink/new-category') }}"><a
                                        href="{{ route('admin.dlcategory.new') }}">{{ __('Add New Category') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/dlink/page-settings') }}"><a
                                    href="{{ route('admin.dlink.page.settings') }}">{{ __('Page Settings') }}</a>
                                </li>
                            </ul>
                        </li>
                    @endif

                    @if (check_page_permission_by_string('Ntender Manage'))
                        <li
                            class="main_dropdown
                        @if (request()->is(['admin-home/ntender/*', 'admin-home/ntender'])) active @endif
                        ">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i>
                                <span>{{ __('Notices & Tenders') }}</span></a>
                            <ul class="collapse">
                                <li class="{{ active_menu('admin-home/ntender') }}"><a
                                    href="{{ route('admin.ntenders') }}">{{ __('All Notices & Tenders') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/ntender/new') }}"><a
                                    href="{{ route('admin.ntender.new') }}">{{ __('Add Notice & Tender') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/ntender/category') }}"><a
                                    href="{{ route('admin.ntcategories') }}">{{ __('All Categories') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/ntender/new-category') }}"><a
                                        href="{{ route('admin.ntcategory.new') }}">{{ __('Add New Category') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/ntender/page-settings') }}"><a
                                    href="{{ route('admin.ntender.page.settings') }}">{{ __('Page Settings') }}</a>
                                </li>
                            </ul>
                        </li>
                    @endif

                    {{-- @if (check_page_permission_by_string('Visitor Manage'))
                        <li
                            class="main_dropdown
                        @if (request()->is(['admin-home/visitor/*', 'admin-home/visitor'])) active @endif
                        ">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i>
                                <span>{{ __('Visitor Counter') }}</span></a>
                            <ul class="collapse">
                                <li class="{{ active_menu('admin-home/visitor') }}"><a
                                        href="{{ route('admin.visitor') }}">{{ __('All Visitors') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/visitor/new') }}"><a
                                        href="{{ route('admin.visitor.new') }}">{{ __('Add New Visitors') }}</a>
                                </li>
                            </ul>
                        </li>
                    @endif --}}

                    @if (check_page_permission_by_string('Photo Manage'))
                        <li
                            class="main_dropdown
                        {{ active_menu('admin-home/photo-page') }}
                        @if (request()->is('admin-home/photo-page/*')) active @endif
                                ">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i>
                                <span>{{ __('Tourist Month Pic') }}</span></a>
                            <ul class="collapse">
                                <li class="{{ active_menu('admin-home/photo-page') }}">
                                    <a href="{{ route('admin.photo.all') }}">{{ __('Pic of the Month') }}</a>
                                </li>
                            </ul>
                        </li>
                    @endif
                    ...
                    <li class="main_dropdown @if (request()->is(['admin-home/home-page-01/*', 'admin-home/home-' . $home_page_variant . '/*', 'admin-home/header', 'admin-home/keyfeatures', 'admin-home/about-page/*', 'admin-home/contact-page/*', 'admin-home/feedback-page/*', 'admin-home/404-page-manage', 'admin-home/maintains-page/settings', 'admin-home/page-builder/*'])) active @endif
                        ">
                        <a href="javascript:void(0)" aria-expanded="true"><i class="ti-settings"></i>
                            <span>{{ __('All Page Settings') }}</span></a>
                        <ul class="collapse ">
                            @if (check_page_permission_by_string('Home Page Manage'))
                                <li class="main_dropdown @if (request()->is(['admin-home/home-' . $home_page_variant . '/*', 'admin-home/home-page-01/*', 'admin-home/header', 'admin-home/keyfeatures', 'admin-home/page-builder/home-page'])) active @endif">
                                    <a href="javascript:void(0)" aria-expanded="true">
                                        {{ __('Home Page Manage') }}
                                    </a>
                                    <ul class="collapse">
                                        ...
                                        @if (empty(get_static_option('home_page_page_builder_status')))
                                            ...
                                            @if ($home_page_variant == '09')
                                                ...
                                                <li class="{{ active_menu('admin-home/home-09/video-area') }}">
                                                    <a href="{{ route('admin.home09.video.area') }}">
                                                        {{ __('Video area') }}
                                                    </a>
                                                </li>
                                                <li class="{{ active_menu('admin-home/home-09/announcement-area') }}">
                                                    <a href="{{ route('admin.home09.announcement.area') }}">
                                                        {{ __('Announcement Area') }}
                                                    </a>
                                                </li>
                                                <li class="{{ active_menu('admin-home/home-09/notice-area') }}">
                                                    <a href="{{ route('admin.home09.notice.area') }}">
                                                        {{ __('Notice Area') }}
                                                    </a>
                                                </li>
                                                ...
                                                <li class="{{ active_menu('admin-home/home-09/gallery-area') }}">
                                                    <a href="{{ route('admin.home09.gallery.area') }}">
                                                        {{ __('Gallery Area') }}
                                                    </a>
                                                </li>
