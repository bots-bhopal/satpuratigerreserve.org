    ...
    <div class="main-content-inner">
        <div class="row">
            <div class="col-lg-12">
                ...
                @if(check_page_permission_by_string('news_manage'))
                ...
                @if(check_page_permission_by_string('event_manage'))
                    <div class="col-md-3 mt-md-5 mb-3">
                        <div class="card text-dark  mb-3">
                            <div class="dsh-box-style">
                                <a href="{{route('admin.strevent.new')}}" class="add-new"><i class="ti-plus"></i></a>
                                <div class="icon">
                                    <i class="ti-blackboard"></i>
                                </div>
                                <div class="content">
                                    <span class="total">{{$event_count}}</span>
                ...
                @if(check_page_permission_by_string('dlink_manage'))
                    <div class="col-md-3 mt-md-5 mb-3">
                        <div class="card text-dark  mb-3">
                            <div class="dsh-box-style">
                                <a href="{{ route('admin.dlink.new') }}" class="add-new"><i class="ti-plus"></i></a>
                                <div class="icon">
                                    <i class="ti-blackboard"></i>
                                </div>
                                <div class="content">
                                    <span class="total">{{$dlinks_count}}</span>
                                    <h4 class="title">{{__('Total Documents & Links')}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                @if(check_page_permission_by_string('ntender_manage'))
                    <div class="col-md-3 mt-md-5 mb-3">
                        <div class="card text-dark  mb-3">
                            <div class="dsh-box-style">
                                <a href="{{ route('admin.ntender.new') }}" class="add-new"><i class="ti-plus"></i></a>
                                <div class="icon">
                                    <i class="ti-blackboard"></i>
                                </div>
                                <div class="content">
                                    <span class="total">{{$ntender_count}}</span>
                                    <h4 class="title">{{__('Total Notices & Tenders')}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
